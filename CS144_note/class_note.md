...
![[Pasted image 20251029105110.png]]
...
* 这个值对于实际只有`100ms`的包来说,实际我们按照`2 * r = 200ms`判断这个包有没有丢,这其实太激进了
...
* 换句话说,我们需要一个网络波动小就保守,网络波动大就激进的算法
...
* 那么我们看看`TCP Tahoe`做了什么:
	...
	5. 重新计算`new_v = old_v + h * (|e| - old_v)`,`h`一般取`1/4`
